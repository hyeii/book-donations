package com.bookdone.global.jwt;
...
import com.bookdone.global.security.CustomMemberDetails;
...
public class JwtAuthenticationFilter extends OncePerRequestFilter {
    ...
    public JwtAuthenticationFilter(AuthenticationManager authenticationManager, CustomMemberDetailService customMemberDetailService,
        ...
        if (token != null) {
            ...
            if (userId != null) {
                ...
                try {
                    ...
                    UserDetails userDetails = customMemberDetailService.loadUserByUsername(userId);
