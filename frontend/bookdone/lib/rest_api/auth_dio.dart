...
Future<Dio> authDio(BuildContext context) async {
  ...
  dio.interceptors.add(InterceptorsWrapper(onRequest: (options, handler) async {
    ...
    const accessToken =
        'eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzUxMiJ9.eyJzdWIiOiI2IiwiaXNzIjoiYm9va2RvbmUuY29tIiwiZXhwIjoxNjk5MTU3Mzc3LCJpYXQiOjE2OTg5NzczNzd9.frLOrgTajuakbtTiK5MWDOyUaiP9su906TTD2Dfa3NN2HYNDT6PDzc4Mzo_hFd2X8wn-AF8cz_KJp-lFt2eKEQ';
