...
class _RestClient implements RestClient {
  ...
  @override
  Future<DefaultReps> updateFcm(Map<String, dynamic> map) async {
    const _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    final _data = <String, dynamic>{};
  ...
  Future<TradeServerConfirm> reservationRequestTrade(
    ...
    final Map<String, dynamic>? _data = null;
    final _result = await _dio
        .fetch<Map<String, dynamic>>(_setStreamType<TradeServerConfirm>(Options(
      method: 'PATCH',
      headers: _headers,
      extra: _extra,
    )
    ...
    final value = TradeServerConfirm.fromJson(_result.data!);
    return value;
  }
  ...
  @override
  Future<BooksDto> getBooksDetails(List<String> isbns) async {
    const _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{r'isbns': isbns};
    final _headers = <String, dynamic>{};
    final Map<String, dynamic>? _data = null;
    final _result =
        await _dio.fetch<Map<String, dynamic>>(_setStreamType<BooksDto>(Options(
      method: 'GET',
      headers: _headers,
      extra: _extra,
    )
  ...
  @override
  Future<TradeServerConfirm> cancelChatRoom(int tradeId) async {
    const _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    final Map<String, dynamic>? _data = null;
